      ...
      entries(class_to_geometries).forEach(function (_ref3) {
        ...
        class_geometries.forEach(function (class_geometry) {
          if (class_geometry_type === "Point") {
            ...
            if (inside) {
              any_contained = true; // increase number of times the combo is found
...
},{"@turf/area":2,"@turf/boolean-point-in-polygon":3,"@turf/clone":4,"@turf/difference":5,"@turf/meta":8}],2:[function(require,module,exports){
"use strict";
...
},{"@turf/helpers":6,"@turf/invariant":7,"polygon-clipping":9}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
 * @module helpers
